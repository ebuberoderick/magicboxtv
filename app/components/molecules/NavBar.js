    ...
    <div className="fixed z-50 backdrop-blur-md w-screen top-0 right-0">
      <div className="max-w-7xl justify-between p-4 items-center mx-auto flex">
        ...
        <div
          ...
          } fixed bg-black px-6 md:px-0 backdrop-blur-lg bg-opacity-15 md:relative top-0 right-0 w-screen md:w-auto h-screen md:h-auto md:p-0 flex items-center justify-center`}
        >
        ...
        <div
          ...
          className="text-white md:hidden text-2xl flex items-center"
        >
          <div className="p-2 cursor-pointer border-2 border-gray-800 bg-gray-600/25 rounded-lg ">
            <HiOutlineMenuAlt3 />
          </div>
        </div>
      </div>
