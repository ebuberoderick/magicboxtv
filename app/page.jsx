...
import { fetchAPI, fetchGenresAPI, fetchGenresMovieAPI } from "../services/authService";
            ...
            <div className="max-w-7xl px-3 mx-auto ">
              <div className="flex gap-4 items-center">
                <div className="relative top-[2px]">
                  <Link href="/movies">
                    <div className="flex items-center text-gray-400 gap-2 hover:text-white"><div className="relative bottom-[2px]">Movies</div> <LiaAngleRightSolid /> </div>
                  </Link>
                </div>
                <div className="capitalize text-lg md:text-2xl text-white font-semibold">{genre.split("()").join(" ")}</div>
              </div>
            </div>
            <div className="">
