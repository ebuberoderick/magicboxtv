  ...
  return (
    <AppLayout active="series">
      <div className="h-screen bg-gray-950 pt-24 pb-10 px-4">
        <div className="overflow-hidden h-full max-w-7xl mx-auto rounded-lg bg-cover bg-center" style={{ backgroundImage: `url(${movieInfo?.img_banner ?? movieInfo?.img_banner})` }}>
